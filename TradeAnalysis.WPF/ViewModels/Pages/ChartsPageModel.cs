...
public class ChartsPageModel : ViewModelBase
{
    ...
    private readonly ObservableCollection<ChartModel> _accountsPeriodicityCharts = new()
    {
        ...
        new("Количество купленных граффити", LegendValueType.Avg, ChartUnit.Count,
            SelectValue<OperationStatisticElement>(e => e.BuyIgnoredCount)),
        new("Сумма транзакций", LegendValueType.Sum, ChartUnit.Currency,
        ...
        new("Процент профита от стоимости вещи", LegendValueType.Avg, ChartUnit.Percent,
        ...
        new("Процент профита от стоимости инвентаря", LegendValueType.Avg, ChartUnit.Percent,
